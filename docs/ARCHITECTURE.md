...
| `BootReceiver` | [BootReceiver.kt](../app/src/main/java/com/hereliesaz/quicloc/BootReceiver.kt) | Re-posts the reminder notification after reboot, and re-registers Loc Notice's geofences (they don't survive reboot). |
